...
<body>
  <div class="tm-container">
      ...
      <div class="tm-left">
        <div class="tm-left-inner">
          <div class="tm-site-header">
            ...
            <h1 class="tm-site-name">Kazamiza</h1>
          </div>
        ...
        <main class="tm-main">
          ...
          <div id="contact" class="tm-page-content">
            <div class="tm-black-bg tm-contact-text-container">
              <h2 class="tm-text-primary">Contact Kazamiza</h2>
    ...
    <footer class="tm-site-footer">
      <p class="tm-black-bg tm-footer-text">Copyright 2024 Kazamiza</p>
    </footer>
  </div>
